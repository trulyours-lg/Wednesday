...
def find_largest_and_smallest_numbers(num1=0.0, num2=0.0, num3=0.0):
    ...
    if q_list[0]>q_list[1]:
        if q_list[0] <= q_list[2]:
            my_sort =(q_list[2],q_list[1],q_list[0])
            print(my_sort)
        else:
            if q_list[2] > q_list[1]:
               my_sort =(q_list[1],q_list[2],q_list[0])
               print(my_sort)
    elif q_list[0]<q_list[1]:
        if q_list[0]<q_list[2]:
            if q_list[1]<q_list[2]:
                my_sort =(q_list[0],q_list[1],q_list[2])
                print(my_sort)
            else:
                my_sort=(q_list[0],q_list[2],q_list[1])
                print(my_sort)
        else:
            my_sort=(q_list[2],q_list[0],q_list[1])
            print(my_sort)
